...
export const UI_TRANSLATIONS = {
  ...
  es: {
    ...
    subtitle: "Tu compañero cripto personal",
    ...
    amountPlaceholder: "Dejar vacío para seguir sin cantidad",
    buyPrice: "Precio de Compra (USD) (opcional)",
    buyPricePlaceholder: "Dejar vacío sin precio",
    addToPortfolio: "Agregar al Portafolio",
    marketTitle: "Mercado",
    marketSubtitle: "Datos de mercado en vivo",
    topGainers: "🔥 Mayores Ganancias (24h)",
    topLosers: "📉 Mayores Pérdidas (24h)",
    topCoins: "💎 Top 20 por Capitalización",
    marketCap: "Cap",
    volume: "Vol",
    change24h: "24h",
    price: "Precio",
    ...
    comeBackTomorrow: "¡Vuelve mañana por más Papas!",
    howItWorks: "Cómo funciona",
    claim10Points: "Reclama 10 Puntos Patata cada 24 horas",
    buildStash: "Acumula tus Papas manteniéndote activo",
    createAccountAt20:
    ...
    translationError: "Error de traducción. Inténtalo de nuevo.",
    article: "Artículo",
    share: "Compartir",
  ...
  fr: {
    ...
    market: "Marché",
    analysis: "Analyse",
    swipeToSeeMore: "Glisser pour voir plus →",
  ...
  pt: {
    ...
    market: "Mercado",
    analysis: "Análise",
    swipeToSeeMore: "Deslize para ver mais →",
    trackingOnly: "Apenas rastreamento",
  },
  bg: {
    topStory: "ТОП ИСТОРИЯ",
    livePrices: "АКТУАЛНИ ЦЕНИ",
    allNews: "Всички",
    cryptoNews: "Крипто",
    market: "Пазар",
    analysis: "Анализ",
    swipeToSeeMore: "Плъзнете за повече →",
    trackingOnly: "Само проследяване",
    loading: "Зареждане...",
    error: "Грешка",
    retry: "Опитай отново",
    cancel: "Отказ",
  ...
  tr: {
    topStory: "ÜST HABER",
    livePrices: "CANLI FİYATLAR",
    allNews: "Tümü",
    cryptoNews: "Kripto",
    market: "Piyasa",
    analysis: "Analiz",
    swipeToSeeMore: "Daha fazlası için kaydır →",
    trackingOnly: "Sadece takip",
    loading: "Yükleniyor...",
    error: "Hata",
    retry: "Tekrar Dene",
    cancel: "İptal",
  ...
  hi: {
    topStory: "शीर्ष समाचार",
    livePrices: "लाइव प्राइस",
    allNews: "सभी",
    cryptoNews: "क्रिप्टो",
    market: "बाजार",
    analysis: "विश्लेषण",
    swipeToSeeMore: "अधिक देखने के लिए स्वाइप करें →",
    trackingOnly: "केवल ट्रैकिंग",
  },
  ar: {
    topStory: "القصة الرئيسية",
    livePrices: "الأسعار المباشرة",
    allNews: "الكل",
    cryptoNews: "العملات الرقمية",
    market: "السوق",
    analysis: "تحليل",
    swipeToSeeMore: "اسحب لرؤية المزيد ←",
    trackingOnly: "التتبع فقط",
  },
};
